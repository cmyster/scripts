...
# This script will send a report about customer case bugs which are missing
# certain elements and send a report of whats missing.
# Requires:
...
if ! check_login
then
    echo "Bad credentials, Can't conitue."
    exit 1
fi
