#!/usr/bin/python
from dbus import SessionBus as SB
from dbus import Interface as IF
import argparse
...
def setwallpaper(filepath, plugin = 'org.kde.image'):
    ...
    """
    bus = SB()
    plasma = IF(bus.get_object('org.kde.plasmashell', '/PlasmaShell'), dbus_interface='org.kde.PlasmaShell')
